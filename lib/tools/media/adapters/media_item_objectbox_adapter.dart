...
class MediaItemObjectBoxAdapter implements PersistenceAdapter<MediaItem> {
  ...
  @override
  Future<MediaItem?> findById(String uuid) async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');

  @override
  Future<MediaItem> getById(String uuid) async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');

  @override
  @deprecated
  Future<MediaItem?> findByIntId(int id) async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');

  @override
  @deprecated
  Future<MediaItem> getByIntId(int id) async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');

  @override
  Future<List<MediaItem>> findAll() async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');
  ...
  @override
  Future<List<MediaItem>> findUnsynced() async => throw UnimplementedError(
      'MediaItem persistence not yet available on native platforms');
