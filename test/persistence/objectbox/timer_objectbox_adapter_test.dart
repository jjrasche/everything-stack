/// Integration tests for TimerObjectBoxAdapter
///
/// Verifies:
...
import 'package:everything_stack_template/tools/timer/adapters/timer_objectbox_adapter.dart';
import 'package:everything_stack_template/objectbox.g.dart';

void main() {
  late Store store;
  late Directory testDir;
  late TimerObjectBoxAdapter adapter;

  setUp(() async {
    testDir = await Directory.systemTemp.createTemp('timer_objectbox_test_');
    store = await openStore(directory: testDir.path);
    adapter = TimerObjectBoxAdapter(store);
  });
  ...
  group('TimerObjectBoxAdapter - CRUD Operations', () {
  ...
  group('TimerObjectBoxAdapter - Timer-Specific Queries', () {
  ...
  group('TimerObjectBoxAdapter - Time-Based Behavior', () {
